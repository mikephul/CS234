...
TF_VERSION="https://storage.googleapis.com/tensorflow/linux/gpu/tensorflow_gpu-1.0.1-cp27-none-linux_x86_64.whl"
...
if [ ! -f "$CUDNN_ARCHIVE" ]; then
    wget https://web.stanford.edu/~czeng2/cudnn-8.0-linux-x64-v5.1.tgz
fi
